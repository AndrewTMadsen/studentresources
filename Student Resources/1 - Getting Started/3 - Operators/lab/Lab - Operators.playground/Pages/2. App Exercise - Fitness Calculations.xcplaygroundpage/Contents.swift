...
let addedHeartRate = heartRate3 + heartRate2 + heartRate1
let averageHRD = addedHeartRate / 3
/*:
 ...
 */
let stepsTaken: Double = 3_467
let stepsGoal: Double = 10_000
let percentOfGoal = 10_000 / 3_467
