 ...
 */
//let destroyer = Fighter(weaponName: "laser", remainingFirePower: 10)
 ...
 */
//print(destroyer.weaponName)
// beacause it is a class and not a struct classes are a blueprints and struct's are more of guildline... i dont know
